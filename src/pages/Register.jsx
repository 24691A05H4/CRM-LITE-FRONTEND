...
// Premium registration page with glassmorphism card and smooth animations
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 dark:from-[#090A0F] dark:via-[#0D0E15] dark:to-[#111327] px-4 transition-colors duration-300">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 w-80 h-80 bg-indigo-400/20 dark:bg-indigo-600/10 rounded-full blur-3xl" />
        <div className="absolute -bottom-40 -right-40 w-96 h-96 bg-blue-400/15 dark:bg-blue-600/10 rounded-full blur-3xl" />
        <div className="absolute top-1/3 right-1/4 w-64 h-64 bg-purple-400/10 dark:bg-purple-600/5 rounded-full blur-3xl" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="bg-white/80 dark:bg-[#12131C]/80 backdrop-blur-xl border border-gray-200/60 dark:border-gray-700/50 rounded-2xl shadow-xl dark:shadow-2xl p-8">
          <div className="text-center mb-6">
            <h1 className="text-xl font-bold text-gray-800 dark:text-white">Create your account</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">
              Get started with CRM Lite in seconds
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* Name */}
            <div>
              <label htmlFor="register-name" className="block text-xs font-semibold text-gray-600 dark:text-gray-300 mb-1.5">
                Full Name
              </label>
            ...
            {/* Email */}
            <div>
              <label htmlFor="register-email" className="block text-xs font-semibold text-gray-600 dark:text-gray-300 mb-1.5">
                Email Address
              </label>
              <div className="relative">
            ...
            {/* Password */}
            <div>
              <label htmlFor="register-password" className="block text-xs font-semibold text-gray-600 dark:text-gray-300 mb-1.5">
                Password
              </label>
              <div className="relative">
            ...
            {/* Confirm Password */}
            <div>
              <label htmlFor="register-confirm" className="block text-xs font-semibold text-gray-600 dark:text-gray-300 mb-1.5">
                Confirm Password
              </label>
              <div className="relative">
                <Lock size={16} className="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 dark:text-gray-500" />
        ...
        <p className="text-center text-[10px] text-gray-400 dark:text-gray-600 mt-6">
          © {new Date().getFullYear()} CRM Lite · Secure Registration
        </p>
      </div>
    </div>
  );
